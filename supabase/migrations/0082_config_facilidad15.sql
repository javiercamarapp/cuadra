-- ═══════════════════════════════════════════════════════════════════════════
-- 0082 — config_tenant_valida conoce la facilidad del 15% (RFA 2026 regla 2.9)
--
-- El alta de flota guarda `tenant.config.facilidadCombustibleEfectivo` (la
-- declaración de dedicación/régimen que el motor necesita para abrir la válvula
-- del 15% de diésel en efectivo). El trigger 0026 validaba las llaves de la
-- config contra una lista cerrada, y sin esta actualización el alta de una
-- flota que declare sus datos REVENTABA. Copia íntegra de la función de la
-- 0026 con la décima llave añadida.
-- ═══════════════════════════════════════════════════════════════════════════
...
comment on function config_tenant_valida(jsonb) is
  'Valida tenant.config contra CuadraConfig (0026, ampliada por la 0082 con la facilidad del 15% de la RFA 2026 regla 2.9).';
