...
1. Lee docs/auditoria-15/00-SINTESIS.md y docs/auditoria-15/<tu-rubro>.md — el formato, el estándar de
...
- Busca ERRORES, BUGS, HUECOS y PROBLEMAS DE SEGURIDAD — la ronda 14 cerró ~40 hallazgos; tu trabajo
  es encontrar lo que quedó, lo que se rompió al arreglar, y las regresiones.
- Verifica los cierres de la ronda 14: abre el código y confirma que el fix está y hace lo que dice.
...
ENTREGABLE: docs/auditoria-15/<tu-rubro>.md con:
...
- Hallazgos por severidad (CRÍTICO / ALTO / MEDIO / BAJO), cada uno con archivo:línea, escenario con
  valores, y estado (abierto / cerrado con commit / falso positivo de la ronda 14).
...
- Los hallazgos de la ronda 14 están en docs/auditoria-15/ — verifica sus cierres.
