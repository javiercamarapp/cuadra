...
1. Lee docs/auditoria-12/00-SINTESIS.md y docs/auditoria-12/<tu-rubro>.md — el formato, el estándar de
...
- Busca ERRORES, BUGS, HUECOS y PROBLEMAS DE SEGURIDAD — la ronda 12 cerró ~40 hallazgos; tu trabajo
  es encontrar lo que quedó, lo que se rompió al arreglar, y las regresiones.
- Verifica los cierres de la ronda 12: abre el código y confirma que el fix está y hace lo que dice.
...
ENTREGABLE: docs/auditoria-13/<tu-rubro>.md con:
...
- Hallazgos por severidad (CRÍTICO / ALTO / MEDIO / BAJO), cada uno con archivo:línea, escenario con
  valores, y estado (abierto / cerrado con commit / falso positivo de la ronda 12).
...
- Los hallazgos de la ronda 12 están en docs/auditoria-12/ — verifica sus cierres.
